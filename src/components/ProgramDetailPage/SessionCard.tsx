...
export function SessionCard({
  ...
  exerciseDetails,
  isComplete,
  image = "figma:asset/e7463f53907ff11b31d5f786913d5c0104281a57.png",
  onAction
}: SessionCardProps) {
  return (
    <div 
      className="relative overflow-hidden bg-black rounded-[20px] h-[400px] cursor-pointer"
      style={{
