...
interface AccountDashboardPageDesktopProps {
  ...
  onAccountCreated?: (email: string, firstName: string, lastName: string, selectedProgram: string | null) => void;
}
...
export function AccountCreationDesktop({ onClose, onNavigate, onAccountCreated }: AccountDashboardPageDesktopProps) {
  ...
  return (
    <div 
      className="transition-opacity duration-700 relative z-20"
      style={{ opacity: 1 }}
    >
      ...
      {currentStep === 1 && (
        <>
          <h2 
            className="mb-12 font-[DM_Sans] font-light text-white relative z-20"
            style={{
              fontSize: '27px',
          ...
          <div className="max-w-2xl relative z-20">
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div>
                <label 
                  htmlFor="firstName" 
                  className="block mb-2 font-[DM_Sans] text-gray-400"
                  style={{
                    fontSize: '12px',
                    letterSpacing: '0.1em'
                  }}
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#D4AF37] text-black hover:bg-[#E5C158] transition-all duration-500 font-[DM_Sans] rounded-[25px] ml-auto disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#D4AF37]"
              style={{
                fontSize: '13px',
            ...
            {/* Terms Text */}
            <p 
              className="mt-6 text-gray-400 font-[DM_Sans]"
              style={{
                fontSize: '11px',
                letterSpacing: '0.01em',
                maxWidth: '330px',
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#D4AF37] transition-colors"
                >
      ...
      {currentStep === 3 && (
        <>
          <h2 
            className="mb-6 font-[DM_Sans] font-light text-white relative z-20"
            style={{
              fontSize: '27px',
              letterSpacing: '-0.01em',
              lineHeight: '1.1'
          ...
          <p 
            className="mb-12 text-gray-400 font-[DM_Sans] relative z-20"
            style={{
              fontSize: '13px',
              letterSpacing: '0.01em',
              lineHeight: '1.6'
          ...
          <div 
            ...
            className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide gap-8 relative z-20 mb-12"
            style={{ 
              scrollbarWidth: 'none', 
          ...
          >
            {FREE_PROGRAMS.map((program) => (
              ...
              >
                <div
                  className={`relative rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 ring-2 ${
                    selectedProgram === program.id 
                      ? 'ring-[rgba(34,197,94,1)] shadow-[0_0_40px_rgba(34,197,94,0.5)]' 
                      : 'ring-[#D4AF37]'
                  }`}
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-10">
                    {/* Category Badge */}
                    <div 
                      className="mb-4 inline-flex items-center px-4 py-2 rounded-full font-[DM_Sans] self-start"
                      style={{
                        fontSize: '10px',
                    ...
                    {/* Subtitle */}
                    <p 
                      className="text-gray-300 font-[DM_Sans] mb-6 whitespace-pre-line"
                      style={{
                        fontSize: '13px',
          ...
          {/* Pagination Dots */}
          <div className="flex justify-center items-center gap-3 mb-12 relative z-20">
            {FREE_PROGRAMS.map((_, index) => (
              <button
                key={index}
                onClick={() => scrollToProgramSlide(index)}
                className={`h-0.5 rounded-full transition-all duration-300 ${
                  index === currentProgramSlide ? 'w-16 bg-[#D4AF37]' : 'w-16 bg-gray-700'
                }`}
              />
            ))}
          </div>
          ...
          <div className="flex justify-center relative z-20">
            <button
              ...
              onClick={() => {
                if (selectedProgram) {
                  // Call the callback to log the user in automatically
                  if (onAccountCreated) {
                    onAccountCreated(email, firstName, lastName, selectedProgram);
                  }
                  onNavigate('account');
                }
              }}
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#D4AF37] text-black hover:bg-[#E5C158] transition-all duration-500 font-[DM_Sans] rounded-[25px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#D4AF37]"
              style={{
                fontSize: '13px',
                letterSpacing: '0.12em',
                fontWeight: 500,
          ...
          <p 
            className="mt-6 text-gray-400 font-[DM_Sans] text-center relative z-20"
            style={{
              fontSize: '11px',
              letterSpacing: '0.01em',
              lineHeight: '1.6'
